...
class MonoDataset(data.Dataset):
    ...
    def __init__(self,
        ...
        self.to_norm = tvf.Compose([tvf.ToTensor(), tvf.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))])
    ...
    def preprocess(self, inputs, color_aug):
        ...
        for k in list(inputs):
            ...
            if "color" in k:
                ...
                inputs[(n + "_norm", im, i)] = self.to_norm(f)
                inputs[(n + "_norm_aug", im, i)] = self.to_norm(color_aug(f))
